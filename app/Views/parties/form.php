...
<div class="card" style="max-width:620px">
  <form method="post" action="<?= $action ?>">
    ...
    <label class="inline" style="font-weight:400">
      <input type="checkbox" name="is_active" value="1" style="width:auto" <?= old('is_active', $row['is_active'] ?? 1) ? 'checked' : '' ?>> Active
    </label>
    <?php if (! empty($cfDefs)): ?>
    ...
    <div class="btn-group" style="margin-top:14px">
      ...
      <a class="btn ghost" href="<?= site_url($route) ?>">Cancel</a>
    </div>
  </form>
</div>
