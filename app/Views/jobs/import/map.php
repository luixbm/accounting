...
<div class="page-head">
  <div><h1><?= lang('Import.jb_crumb_map') ?></h1><div class="muted small"><?= esc($batch['filename']) ?></div></div>
  <div class="btn-group"><a class="btn ghost" href="<?= site_url('jobs/import') ?>"><?= lang('App.cancel') ?></a></div>
</div>
